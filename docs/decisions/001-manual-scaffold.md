...
Starting a new Next.js project, there are two paths: run `npx create-next-app` (automated) or write every file by hand. This is both a portfolio project and a learning exercise — the goal is to understand the codebase deeply enough to explain every file in an interview.
...
**Harder:**
- Slower start — need to look up exact dependency versions and config shapes
